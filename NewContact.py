...
class NewContact(unittest.TestCase):
    ...
    def test_new_contact(self):
        ...
        self.create_new_contact(wd, Contact(firstname="Yurii", middlename="Ezerskii", lastname="Sergeevich", nickname="Nickname",
                                               title="Title", company="Solar", address="Street", home="HomeNum", mobile="999",
                                               work="Work", fax="fax", email="test@gmail.com", bday="1", bmonth="January", byear="2024"))
        self.go_home(wd)
    ...
    def is_alert_present(self):
        try: self.wd.switch_to_alert() # рефакторить устаревший метод
